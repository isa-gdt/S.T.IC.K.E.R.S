...
@section('banner-register')
    <div class="grid--item grid--item__12">
        <h1>My Collection</h1>
        <form id="create-pack" action="{{route('pack.create')}}" method="post">
            @csrf
